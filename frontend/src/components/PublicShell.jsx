...
import AgentforceWidget from "./AgentforceWidget";
...
/**
 * Unauthenticated page chrome: public navbar (logo + Login), footer and the
 * unauthorized Agentforce chatbot. Wraps every public page (FAQ landing,
 * Connected Services topic + article pages) so the chat session and header
 * stay consistent across SPA navigation.
 */
